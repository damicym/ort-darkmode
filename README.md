...
## Como usarlo
1. [Descargá la carpeta comprimida de la extensión](https://github.com/user-attachments/files/31917426/ort-darkmode.zip) o cloná el repositorio.
...
* La extensión funciona aplicando una inversión de color a toda la página.
* Te agrega arriba a la izquierda un panel con 2 botones:
